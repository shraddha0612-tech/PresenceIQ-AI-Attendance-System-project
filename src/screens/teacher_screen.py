...
from src.components.diag_attendance_results import attendance_result_dialog
import numpy as np
...
def teacher_dashboard():
     ...
     with c2:
          ...
          if(st.button("Logout", type='secondary', key='loginbackbtn',shortcut="ctrl+b")):
     ...
     with tab3:
          ...
          if st.button('Attendance Records',type=type3, width='stretch',icon=':material/book_ribbon:'):
...
def teacher_tab_manage_subjects():
     ...
     with col1:
          st.header('manage_subjects',width='stretch')
     with col2:
...
def teacher_screen_login():
        ...
        st.header('Login your passward', text_alignment='center')
        st.space()
        st.space()
...
def teacher_screen_register():
        ...
        with c1:
           header_dashboard()
        with c2:
            if(st.button("Go back to Home", type='secondary', key='registerbackbtn',shortcut="ctrl+b")):
                st.session_state.login_type= None
                st.session_state.teacher_login_type = 'login'
                st.rerun()  
